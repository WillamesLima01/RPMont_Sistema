  ...
  return (
    ...
    >
      ...
      <ModalGenerico
        ...
        icone={icone}
        cor={cor}
        titulo={mensagemModalTitulo || (mensagemModalTipo === 'sucesso' ? 'Sucesso' : 'Atenção')}
        subtitulo={mensagemModalTexto}
        tempoDeDuracao={mensagemModalTipo === 'sucesso' ? 3000 : 0} // opcional: não auto-fecha em erro/segurança
        tamanho="medio"
      />
    </div>
  );
